...
public class CachingHttpHeadersFilter implements Filter {
    ...
    public CachingHttpHeadersFilter(FeedMeProperties feedMeProperties) {
        this.feedMeProperties = feedMeProperties;
    }

    @Override
    public void init(FilterConfig filterConfig) throws ServletException {
        CACHE_TIME_TO_LIVE = TimeUnit.DAYS.toMillis(feedMeProperties.getHttp().getCache().getTimeToLiveInDays());
    }
